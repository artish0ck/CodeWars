...
Otherwise, return "Oi! Sheep number N! You are about to be eaten by a wolf!" where N is
the sheep's position in the queue.
...
public class WolfAndSheep {
    public static void main(String[] args) {
        String[] sheepArray = {"sheep", "sheep", "sheep", "sheep", "sheep", "wolf", "sheep", "sheep" };
        System.out.println(warnTheSheep(sheepArray));
    }
